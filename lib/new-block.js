...
/*    var arrayPromises = [];  // promises for each db insertion
    ...
    txList.forEach(function(promise){
        ready = ready.then(function(){
            return promise;
        }).then(function(value){
            arrayPromises.push(value);
        });
    });
    return ready.then(function() {return arrayPromises;});
*/
...
//console.log(txList[each].account, 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', txList[each]);
